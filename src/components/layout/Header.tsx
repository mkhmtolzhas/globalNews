  ...
  return (
    <header className='top-0 left-0 w-full px-[8%] py-[30px] bg-transparent flex justify-between items-center font-mono'>
        ...
        <nav className='hidden md:flex'>
            ...
            <Link href="" className="text-[18px] text-[#000] font-medium mx-[20px] my-[0] [transition:.3s] hover:text-red-600">О нас</Link>
            <Link href="" className="text-[18px] text-[#000] font-medium mx-[20px] my-[0] [transition:.3s] hover:text-red-600">Контакты</Link>
        </nav>
